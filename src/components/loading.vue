...
.main {
  ...
  &::before {
    ...
    transform: translate(-50%, -50%);
    border-radius: 50%;
    box-shadow: 0 0.6rem 0.2rem rgba(0, 0, 0, 0.1);
  }
  &::after {
  ...
  & span:first-of-type {
    ...
    animation: go-left-left 3s infinite;
  ...
  & span:last-of-type {
    ...
    animation: go-right-right 3s infinite;
    @media only screen and (max-width: 37.5em) {
      display: none;
    }
  }
